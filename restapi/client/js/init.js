...
(function () {
    ...
    html5app.settings.api = {
        'FOLDERS_URL' : 'http://delavnica.com/api/get/folder/',
        'FOLDERS_ADS_URL':'http://delavnica.com/api/q/folder/{0}/ad',
        'AD_URL' : 'http://delavnica.com/api/get/ad/{0}',
        'SAVE_AD' : 'http://delavnica.com/api/set/ad/'
    };
